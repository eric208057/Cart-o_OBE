...
com mapa + visualizador de PDF da documentação abaixo do mapa.
PDFs no formato: "pop 01.pdf", "pop 02.pdf", ..., "pop 17.pdf" (com espaço)
"""

import os

# Lista completa de 17 pontos
pontos = [
...
# Template HTML completo (com PDF viewer e dados originais)
HTML_TEMPLATE = """<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    <title>{titulo} - Ponto de Estacionamento da Patrulha - SP</title>
    ...
    <style>
        ...
        .folium-map {{ width:100%; height:55vh; border-radius:12px; overflow:hidden; box-shadow:0 6px 15px rgba(0,0,0,0.8); }}
...
<body>
    ...
    <div class="control-panel">
        ...
        <div class="cluster-legend">
            Áreas de risco (clique para detalhes):<br>
    ...
    <div class="pdf-container">
        ...
        <div style="padding:12px; text-align:center; font-size:0.9rem; color:#888;">
            Se o PDF não carregar, <a href="../pop_pdf/{nome_arquivo_pdf}" target="_blank" style="color:#ff6b6b;">clique aqui para abrir diretamente</a>
        </div>
    </div>
    ...
    <script>
        ...
        riscoData.forEach(item => {{
            ...
            circle.bindPopup(`
                ...
                <b>QTD de Ocorrências no Período (10SET25 à 31DEZ25):</b> ${{item.count}}<br>
        ...
        L.marker([ponto.lat, ponto.lng], {{icon: popIcon}}).addTo(map)
            .bindPopup(`
                <b>${{ponto.nome}}</b><br>
                ${{ponto.endereco}}<br><br>
                <a href="https://www.google.com/maps/search/?api=1&query=${{ponto.lat}},${{ponto.lng}}" target="_blank" rel="noopener" class="popup-link">
...
# Dados fixos originais (agora incluídos corretamente)
CPP_DATA = """{
...
def gerar_html_para_pop(pop_nome, endereco, lat, lng, output_dir="mapas_pop"):
    """Gera arquivo HTML com mapa + visualizador de PDF"""
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)

    titulo = f"{pop_nome} - Ponto de Estacionamento da Patrulha"
    
    # PDF com espaço: "pop 01.pdf", "pop 02.pdf", etc.
    numero = pop_nome.split()[1]  # "01", "02", ...
    nome_arquivo_pdf = f"pop {numero}.pdf"
    
    # HTML com underline: pop_01.html, pop_02.html...
    nome_arquivo_html = f"pop_{numero}.html"
    caminho = os.path.join(output_dir, nome_arquivo_html)
    ...
    print(f"Gerado: {caminho}  →  PDF esperado: ../pop_pdf/{nome_arquivo_pdf}")
...
print("\n" + "="*70)
print("GERAÇÃO CONCLUÍDA - 17 arquivos HTML criados na pasta 'mapas_pop'")
print("• Mapas Leaflet funcionando")
print("• Visualizador de PDF apontando para: 'pop 01.pdf', 'pop 02.pdf', etc.")
print("\nIMPORTANTE - Para visualizar corretamente (mapa + PDF):")
print("1. Coloque os PDFs na pasta pop_pdf/ com nomes exatos: pop 01.pdf até pop 17.pdf")
print("2. Não abra os .html direto do disco (file://)")
print("3. Na pasta raiz do projeto execute:")
