...
viaturas = [
    {
        "codigo": "ESSgt-030",
        "titulo": "ESSgt-030 - Pontos Fixos CPP 1.1 - SP",
        "pdf_principal": "ESSgt-030.pdf",
        "pontos": [
            {"id": "OP BLOQUEIO", "nome": "CPP 1.1 (OP BLOQUEIO)", "endereco": "Av. Dr. Gastão Vidigal, 1142 - Vila Leopoldina", "lat": -23.528903888196563, "lng": -46.739219300274584},
            {"id": "PE 1", "nome": "CPP 1.1 (PE 1)", "endereco": "Av. Queiroz Filho, 1700 - Vila Hamburguesa", "lat": -23.543194691386972, "lng": -46.73265171533143},
            {"id": "PE 2", "nome": "CPP 1.1 (PE 2)", "endereco": "Av. Queiroz Filho, 1315 - Portão 2 - Parque Villa-Lobos", "lat": -23.54182339721191, "lng": -46.73028311175224},
            {"id": "PE 3", "nome": "CPP 1.1 (PE 3)", "endereco": "Av. Queiroz Filho, 1310 - Portão 2 - Parque Villa-Lobos", "lat": -23.541082455584654, "lng": -46.731077403262915},
        ]
    },
    {
        "codigo": "ESSgt-033",
        "titulo": "ESSgt-033 - Pontos Fixos CPP 1.2 - SP",
        "pdf_principal": "ESSgt-033.pdf",
        "pontos": [
            {"id": "PE 1", "nome": "CPP 1.2 (PE 1)", "endereco": "Av. José César de Oliveira, 21 - Vila Leopoldina", "lat": -23.539600294412644, "lng": -46.73399579004857},
            {"id": "PE 2", "nome": "CPP 1.2 (PE 2)", "endereco": "Av. Dr. Gastão Vidigal, 1399 - Vila Leopoldina", "lat": -23.530055448171137, "lng": -46.73768108820495},
            {"id": "OP BLOQUEIO", "nome": "CPP 1.2 (OP BLOQUEIO)", "endereco": "Av. Dr. Gastão Vidigal, 1142 - Vila Leopoldina", "lat": -23.528903888196563, "lng": -46.739219300274584},
        ]
    },
    {
        "codigo": "ESSgt-031",
        "titulo": "ESSgt-031 - Pontos Fixos CPP 2 - SP",
        "pdf_principal": "ESSgt-031.pdf",
        "pontos": [
            {"id": "PE 1", "nome": "CPP 2 (PE 1)", "endereco": "Praça Ada Rogato - Alto da Lapa", "lat": -23.525864791078664, "lng": -46.728401953331854},
            {"id": "PE 2", "nome": "CPP 2 (PE 2)", "endereco": "Praça Augusto Ruschi - Alto da Lapa", "lat": -23.52784041084019, "lng": -46.72500045333086},
            {"id": "PE 3", "nome": "CPP 2 (PE 3)", "endereco": "R. Carlos Weber, 1700 - Vila Leopoldina", "lat": -23.53387488628212, "lng": -46.724876990048614},
            {"id": "PE 4", "nome": "CPP 2 (PE 4)", "endereco": "R. Schilling, 390 - Vila Leopoldina", "lat": -23.530082527805497, "lng": -46.728577961213965},
        ]
    },
    {
        "codigo": "ESSgt-032",
        "titulo": "ESSgt-032 - Pontos Fixos CPP 3 - SP",
        "pdf_principal": "ESSgt-032.pdf",
        "pontos": [
            {"id": "PE 1", "nome": "CPP 3 (PE 1)", "endereco": "R. Monte Pascal, 210 - Lapa", "lat": -23.519726953698694, "lng": -46.722041978984215},
            {"id": "PE 2", "nome": "CPP 3 (PE 2)", "endereco": "Av. Raimundo Pereira de Magalhães, 200 - Jardim Iris", "lat": -23.518211052120805, "lng": -46.71211297470965},
            {"id": "PE 3", "nome": "CPP 3 (PE 3)", "endereco": "Praça Senador José Roberto Leite Penteado, 1083 - Lapa", "lat": -23.521395755450254, "lng": -46.71906784587471},
            {"id": "PE 4", "nome": "CPP 3 (PE 4)", "endereco": "Rua Monte Pascal, 247 - Lapa", "lat": -23.519381740760938, "lng": -46.723333961214365},
        ]
    }
]
...
<head>
    ...
    <style>
        ...
        .pdf-section {{ margin:25px 15px 40px; background:#1a1a1a; border-radius:12px; overflow:hidden; box-shadow:0 6px 15px rgba(0,0,0,0.8); }}
        .pdf-header {{ margin:0; padding:15px; background:#222; text-align:center; font-size:1.4rem; color:#eee; }}
        .pdf-container {{ margin:0 0 20px 0; }}
...
<body>
    ...
    <footer>Sistema de Informação OBE • {codigo} • 2026</footer>
    ...
    <script>
        ...
        pontos.forEach(p => {{
            const icone = (p.id === 'OP BLOQUEIO') ? icons['OP BLOQUEIO'] : icons['default'];
...
for vtr in viaturas:
    ...
    nome_arquivo = f"{vtr['codigo'].lower().replace('-', '_')}.html"
